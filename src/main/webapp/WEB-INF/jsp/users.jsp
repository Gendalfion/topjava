            ...
            <div class="view-box">
                ...
                <table class="table table-striped display" id="datatable">
                    ...
                    <c:forEach items="${users}" var="user">
                        ...
                        <tr id="${user.id}" <c:if test="${!user.enabled}">class="disabledStyle"</c:if>>
                            <td><c:out value="${user.name}"/></td>
                            <td><a href="mailto:${user.email}">${user.email}</a></td>
                            <td>${user.roles}</td>
                            <td><input type="checkbox" <c:if test="${user.enabled}">checked</c:if> onclick="updateUserEnabled(${user.id})"/></td>
